...
public class TAQAnalyzerSpark implements Serializable {
    ...
    TAQAnalyzerSpark(String inputFileName, IFieldType[] fieldType, int startOffset) {
    ...
    TAQAnalyzerSpark(String inputFileName, IFieldType[] fieldType, int startOffset, List<String> tickerSymbols) {
        setMainObjects(inputFileName, fieldType, startOffset);
    ...
    TAQAnalyzerSpark(String inputFileName, IFieldType[] fieldType, String startTime, String endTime, int startOffset) {
        setMainObjects(inputFileName, fieldType, startOffset);
    ...
    TAQAnalyzerSpark(String inputFileName, IFieldType[] fieldType, String startTime, String endTime, int startOffset, List<String> tickerSymbols) {
        setMainObjects(inputFileName, fieldType, startOffset);
        this.tickerSymbols =tickerSymbols;
        this.startTime = startTime;
        this.endTime = endTime;
