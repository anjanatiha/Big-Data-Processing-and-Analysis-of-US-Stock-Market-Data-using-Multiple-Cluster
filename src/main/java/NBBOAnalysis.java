...
public class NBBOAnalysis {
    ...
    public int getIndexSec(String time){
    ...
    public void printBigDecimal(BigDecimal[][] list_arr, int start, int end){
        for(int m=0; m<list_arr.length;m++){
            for(int n=0; n<list_arr[m].length;n++){
                if (list_arr[m][0]==BigDecimal.ZERO)
                    break;
                System.out.print(list_arr[m][n] + " ");
            }
            System.out.print("\n");
    ...
    public void writeFileBigDecimal(BigDecimal[][] time_series_arr, StockExchanges exchangesObj){
        writeHeaderNBBO();
        StringBuilder tempLine = new StringBuilder();
        for(int m=0; m<time_series_arr.length;m++){
            for(int n=0; n<time_series_arr[m].length;n++){
